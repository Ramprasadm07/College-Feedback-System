...
Accredited by APACC (Asia Pacific Accreditation
 And Certification Commission),<br /> Philippines with Gold Level</font></center></td>
</tr>
<?php
...
for($i=0;$i<$count;$i++){
	...
	$result = mysqli_query($conn,"SELECT a,b,c,d,e,f,ic from coursse_mark where course='$course' and dept='".$dep."'");
